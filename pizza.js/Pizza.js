...
function getMeat (runningTotal,text1) {
   ...
   function getVegetable (runningTotal,text1) {
    ...
    var vegetableArry = document.getElementsByClassName("vegetables");
    for (var j = 0; j < vegetableArry.length; j++) {
        if (vegetableArry[j].checked) {
            selectedVegetable.push(vegetableArry[j].value);
            console.log("selected vegetable item: ("+vegetableArry[j].value+")");
            text1 = text1+vegetableArry[j].value+"<br>";
        }
    }
